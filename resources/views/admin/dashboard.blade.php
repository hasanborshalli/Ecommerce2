...
<div class="admin-stat-grid">
    ...
    <div class="stat-card">
        ...
        <div class="stat-card-sub">
            ...
            @if($revenueGrowth >= 0)
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--success)" stroke-width="2.5">
                <polyline points="18 15 12 9 6 15" />
            </svg>
            <span style="color:var(--success)">+{{ $revenueGrowth }}%</span>
            @else
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--danger)" stroke-width="2.5">
        ...
        <div class="admin-card-header">
            ...
            <div style="display:flex;gap:var(--sp-3);font-size:var(--text-xs);align-items:center">
                <span style="display:flex;align-items:center;gap:var(--sp-1)">
                    <span
                        style="width:10px;height:3px;background:var(--blue);border-radius:2px;display:inline-block"></span>
                    Revenue
                </span>
                <span style="display:flex;align-items:center;gap:var(--sp-1)">
                    <span
...
<div class="admin-grid-main-aside-xl" style="margin-bottom:var(--sp-5)">
    {{-- Recent orders --}}
    <div class="admin-card">
        <div class="admin-card-header">
        ...
        <div class="table-wrap table-stack-mobile" style="border:none;border-radius:0">
            ...
            <div class="admin-card-body" style="padding:0">
                ...
                <div
                    ...
                    <div style="display:flex;align-items:center;gap:var(--sp-3);min-width:0">
                        <span
                            style="width:22px;height:22px;background:{{ $i === 0 ? 'var(--blue)' : 'var(--gray-200)' }};color:{{ $i === 0 ? 'white' : 'var(--gray-600)' }};border-radius:var(--radius-full);display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:var(--weight-bold);flex-shrink:0">{{
                            $i + 1 }}</span>
